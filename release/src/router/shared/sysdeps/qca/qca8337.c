...
#if defined(RTAC55U) || defined(RTAC55UHP) || defined(RT4GAC55U) || defined(RTAC59U) || defined(RTAC59U_V2) || defined(PLN12) || defined(PLAC56) || defined(PLAC66U) || defined(RPAC51)
...
#elif defined(ZENWIFICD6R) || defined(ZENWIFICD6N)
enum {
	P0_PORT=0,
	LAN1_PORT=3,
	LAN2_PORT=1,
