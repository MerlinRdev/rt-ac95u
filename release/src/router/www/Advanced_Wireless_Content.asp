...
function enableSmartCon(val){
	...
	if(isSupport("triband") && dwb_info.mode) {
		...
		else if(based_modelid == "RT-AC88U" || based_modelid == "RT-AC86U" || based_modelid == "GT-AC2900" || based_modelid == "RT-AC3100" || based_modelid == "BLUECAVE" || based_modelid == "MAP-AC1750"){
			desc = ["Dual-Band Smart Connect (2.4GHz and 5GHz)"];
			value = ["1"];
			add_options_x2(document.form.smart_connect_t, desc, value, val);
		}
								...
								<script type="text/javascript">
									...
									if(flag == '')
										...
										$('#radio_smartcon_enable').iphoneSwitch( smart_connect_flag_t > 0, 
										 function() {
											if(based_modelid != "RT-AC5300" && based_modelid != "GT-AC5300" && based_modelid !="RT-AC3200" && based_modelid != "RT-AC88U" && based_modelid != "RT-AC86U" && based_modelid != "GT-AC2900" && based_modelid != "RT-AC3100" && based_modelid != "BLUECAVE" && based_modelid != "MAP-AC1750"  && based_modelid != "RT-AC95U")
												enableSmartCon(1);
											else{
