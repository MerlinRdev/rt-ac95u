...
#endif
#if (defined(PLN12) || defined(PLAC56) || defined(PLAC66U) || defined(RPAC66) || defined(RPAC51) || defined(MAPAC1750) || defined(RTN19) || defined(RTAC59U) || defined(RTAC59U_V2) || defined(ZENWIFICD6R) || defined(ZENWIFICD6N))
...
void config_switch(void)
{
	...
	case MODEL_ZENWIFICD6R:	/* fall through */
	case MODEL_ZENWIFICD6N:	/* fall through */
...
#define WLFW_CAL_01_BIN			"/data/vendor/wifi/wlfw_cal_01.bin"
	int cold_boot = 0;
...
#define RAM512_OLCFG3_EXTRA_PBUF_CORE0		"4500000"
#define RAM512_OLCFG3_2B_ON_HIGH_WATER_CORE0	"39840"
#define RAM512_OLCFG3_2B_ON_WIFI_POOL_BUF	"8192"
/* total pbuf size is 160 bytes,allocate memory for 18904 pbufs */
#define RAM512_OLCFG_EXTRA_PBUF_CORE0		"3100000"
#define RAM512_OLCFG_2B_ON_HIGH_WATER_CORE0	"30624"
#define RAM512_OLCFG_2B_ON_WIFI_POOL_BUF	"8192"

#if defined(GTAXY16000)				/* HK09 */
/* total pbuf size is 160 bytes,allocate memory for 55672 pbufs */
#define HE20_OLCFG_EXTRA_PBUF_CORE0		"9000000"
#define HE20_OLCFG_2B_ON_HIGH_WATER_CORE0	"67392"
/* initially after init 4k buf for 5G and 4k for 2G will be allocated, later range will be configured */
#define HE20_OLCFG_2B_ON_WIFI_POOL_BUF		"40960"

/* total pbuf size is 160 bytes,allocate memory for 57184 pbufs */
#define HE12_OLCFG_EXTRA_PBUF_CORE0		"9200000"
#define HE12_OLCFG_2B_ON_HIGH_WATER_CORE0	"68904"
#define HE12_OLCFG_2B_ON_WIFI_POOL_BUF		"32768"
...
#define OLCFG3_EXTRA_PBUF_CORE0			"13000000"
#define OLCFG3_2B_ON_HIGH_WATER_CORE0		"88896"
/* initially after init 4k buf for 5G and 4k for 2G will be allocated, later range will be configured */
#define OLCFG3_2B_ON_WIFI_POOL_BUF		"53248"
...
#define HE20_OLCFG_EXTRA_PBUF_CORE0		"6000000"
#define HE20_OLCFG_2B_ON_HIGH_WATER_CORE0	"48128"
/* initially after init 4k buf for 5G and 4k for 2G will be allocated, later range will be configured */
#define HE20_OLCFG_2B_ON_WIFI_POOL_BUF		"24576"
#endif
...
static void __load_wifi_driver(int testmode)
{
	...
	int i, unit, len;
	unsigned int olcfg __attribute__((unused)) = nss_wifi_offloading(), hk_ol_num;
	FILE *fp_wifi;
	const char **up;
	...
	*v++ = "qwrap_enable=0";	/* SPF10.0 FC */
	...
	if (total_mem <= (256 * 1024)) {
		...
		if (hk_ol_num == 3) {
			extra_pbuf_core0 = RAM512_OLCFG3_EXTRA_PBUF_CORE0;
			n2h_high_water_core0 = RAM512_OLCFG3_2B_ON_HIGH_WATER_CORE0;
			n2h_wifi_pool_buf = RAM512_OLCFG3_2B_ON_WIFI_POOL_BUF;
		} else {
		...
		if (soc_version_major == 2) {
			extra_pbuf_core0 = HE20_OLCFG_EXTRA_PBUF_CORE0;
			if (olcfg) {
				n2h_high_water_core0 = HE20_OLCFG_2B_ON_HIGH_WATER_CORE0;
				n2h_wifi_pool_buf = HE20_OLCFG_2B_ON_WIFI_POOL_BUF;
			}
		} else {
			extra_pbuf_core0 = HE12_OLCFG_EXTRA_PBUF_CORE0;
			if (olcfg) {
				n2h_high_water_core0 = HE12_OLCFG_2B_ON_HIGH_WATER_CORE0;
				n2h_wifi_pool_buf = HE12_OLCFG_2B_ON_WIFI_POOL_BUF;
			}
		}
#elif defined(RTAX89U)
		if (hk_ol_num == 3) {
			extra_pbuf_core0 = OLCFG3_EXTRA_PBUF_CORE0;
			n2h_high_water_core0 = OLCFG3_2B_ON_HIGH_WATER_CORE0;
			n2h_wifi_pool_buf = OLCFG3_2B_ON_WIFI_POOL_BUF;
		} else {
			extra_pbuf_core0 = HE20_OLCFG_EXTRA_PBUF_CORE0;
			if (olcfg) {
				n2h_high_water_core0 = HE20_OLCFG_2B_ON_HIGH_WATER_CORE0;
...
#elif defined(RTN19) || defined(RTAC59U) || defined(RTAC59U_V2) || defined(MAPAC1750) || defined(ZENWIFICD6R) || defined(ZENWIFICD6N)
	f_write_string("/proc/net/skb_recycler/flush", "1", 0, 0);
...
void init_syspara(void)
{
	...
	nvram_set("et0macaddr", macaddr);
#if defined(RTAC95U) /*SYNC LAN as 2.4G */
...
set_wan_tag(char *interface)
{
	...
	case MODEL_RTN19:
	case MODEL_RTAC59U:
	case MODEL_ZENWIFICD6R:
	case MODEL_ZENWIFICD6N:
	case MODEL_RTAC58U:
