...
#if defined(CONFIG_MAPAC1300) || defined(CONFIG_MAPAC2200) || defined(CONFIG_VZWAC1300) || defined(CONFIG_RTAC95U)
/* we already do chip initialization & load engine in bootcode */
#else
