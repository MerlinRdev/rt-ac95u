...
#define SPI_NAND
#elif defined(CONFIG_RTAC82U) || defined(CONFIG_MAPAC2200) || defined(CONFIG_RTAC95U)
#define RESERVED_BLOCK_SIZE	0
#undef SPI_NAND
#elif defined(CONFIG_MAPAC1300) || defined(CONFIG_VZWAC1300) || defined(CONFIG_SHAC1300)
#define RESERVED_BLOCK_SIZE	0
#define SPI_NAND
#else
